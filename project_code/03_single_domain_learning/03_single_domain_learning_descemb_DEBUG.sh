...
if [ -n "$1" ]; then
    root="${1%/}/DescEmb/"
    MODEL_PATH=("${1%/}/DescEmb/outputs/2024-04-19/15-55-40/checkpoints/checkpoint_mimiciii_descemb_rnn_mlm_last.pt")
else
    root='../DescEmb/'
    MODEL_PATH=('../../../outputs/2024-04-19/15-55-40/checkpoints/checkpoint_mimiciii_descemb_rnn_mlm_last.pt')
fi 
