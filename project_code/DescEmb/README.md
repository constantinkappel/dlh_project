# NOTE: 
This repository was copied from the authors below. The original repository can be found [here](https://github.com/hoon9405/DescEmb). We modified it to work with our data and to run on our system. The original README can be found below:
