...
if [ -n "$1" ]; then
    root="${1%/}/DescEmb/"
    MODEL_PATH=("${1%/}/DescEmb/outputs/2024-05-06/19-20-34/checkpoints/checkpoint_mimiciii_descemb_rnn_ft-mlm_last.pt")
else
    root='../DescEmb/'
    MODEL_PATH=("../../../outputs/2024-05-06/19-20-34/checkpoints/checkpoint_mimiciii_descemb_rnn_ft-mlm_last.pt")
fi 

INPUT_PATH=/data/DescEmb/output #/home/data/output #/data/DescEmb/output
SRC_DATA=('mimiciii' 'eicu')

embed_models=('descemb_rnn')
